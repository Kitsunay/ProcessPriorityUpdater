...
::       It is highly recommended NOT TO USE REALTIME PRIORITY!!!
SET newPriority=128
...
:MAIN_LOOP
    ...
    :: otherwise Windows reverts the priority of the process back to its default value.
    ECHO.
...
:: The core of this script. Performs the main feature: changing the priority of the requested process.
...
:WAIT_BEFORE_NEXT_UPDATE
    :WAIT_LOOP
        ...
        :: to overwrite whatever text was present in the line before. Useful for countdowns and percentage loading screens. ^_^
